...
def latent_multilingual_architecture(args):
    ...
    args.decoder_layers = args.get("decoder_layers", 24)
    args.share_encoders = args.get("share_encoders", True)
    args.share_decoders = args.get("share_decoders", True)
    args.share_encoder_embeddings = args.get("share_encoder_embeddings", True)
    args.share_decoder_embeddings = args.get("share_decoder_embeddings", True)
