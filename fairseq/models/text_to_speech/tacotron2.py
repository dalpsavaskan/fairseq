...
def base_architecture(args):
    ...
    args.encoder_lstm_layers = args.get("encoder_lstm_layers", 1)
    # decoder
    args.attention_dim = args.get("attention_dim", 128)
    args.attention_conv_dim = args.get("attention_conv_dim", 32)
    args.attention_conv_kernel_size = args.get("attention_conv_kernel_size", 15)
    ...
    args.init_attn_c = args.get("init_attn_c", "zero")
    args.attention_use_cumprob = args.get("attention_use_cumprob", True)
    args.zoneout = args.get("zoneout", 0.1)
    args.decoder_lstm_layers = args.get("decoder_lstm_layers", 2)
    args.decoder_lstm_dim = args.get("decoder_lstm_dim", 1024)
