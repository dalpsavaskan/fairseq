...
def transformer_lm_gpt2_big_wide(args):
    args.decoder_embed_dim = args.get("decoder_embed_dim", 2048)
    args.decoder_ffn_embed_dim = args.get("decoder_ffn_embed_dim", 8192)
...
def transformer_lm_gpt2_bigger(args):
    args.decoder_embed_dim = args.get("decoder_embed_dim", 2048)
    args.decoder_ffn_embed_dim = args.get("decoder_ffn_embed_dim", 8192)
    args.decoder_layers = args.get("decoder_layers", 48)
    args.decoder_attention_heads = args.get("decoder_attention_heads", 32)
    args.dropout = args.get("dropout", 0.1)
    args.attention_dropout = args.get("attention_dropout", 0.1)
    args.activation_fn = args.get("activation_fn", "gelu")
