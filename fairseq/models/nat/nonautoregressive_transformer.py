...
class NATransformerDecoder(FairseqNATDecoder):
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.sg_length_pred = args.get("sg_length_pred", False)
        self.pred_length_offset = args.get("pred_length_offset", False)
        self.length_loss_factor = args.get("length_loss_factor", 0.1)
        self.src_embedding_copy = args.get("src_embedding_copy", False)
