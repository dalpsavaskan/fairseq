...
class IterNATransformerModel(NATransformerModel):
    ...
    def build_model(cls, args, task):
        ...
        model.train_step = args.get("train_step", 4)
        model.dae_ratio = args.get("dae_ratio", 0.5)
        model.stochastic_approx = args.get("stochastic_approx", False)
        return model
...
def inat_base_architecture(args):
    ...
    args.train_step = args.get("train_step", 4)
    args.dae_ratio = args.get("dae_ratio", 0.5)
    args.stochastic_approx = args.get("stochastic_approx", False)
