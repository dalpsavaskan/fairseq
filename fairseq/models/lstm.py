...
class LSTMModel(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        max_source_positions = args.get("max_source_positions", DEFAULT_MAX_SOURCE_POSITIONS
        )
        max_target_positions = args.get("max_target_positions", DEFAULT_MAX_TARGET_POSITIONS
        )
...
def base_architecture(args):
    ...
    args.encoder_freeze_embed = args.get("encoder_freeze_embed", False)
    ...
    args.decoder_freeze_embed = args.get("decoder_freeze_embed", False)
    ...
    args.decoder_attention = args.get("decoder_attention", "1")
...
def lstm_wiseman_iwslt_de_en(args):
    ...
    args.encoder_dropout_in = args.get("encoder_dropout_in", 0)
    args.encoder_dropout_out = args.get("encoder_dropout_out", 0)
    args.decoder_embed_dim = args.get("decoder_embed_dim", 256)
    args.decoder_out_embed_dim = args.get("decoder_out_embed_dim", 256)
    args.decoder_dropout_in = args.get("decoder_dropout_in", 0)
    args.decoder_dropout_out = args.get("decoder_dropout_out", args.dropout)
    base_architecture(args)
...
def lstm_luong_wmt_en_de(args):
    args.encoder_embed_dim = args.get("encoder_embed_dim", 1000)
    args.encoder_layers = args.get("encoder_layers", 4)
    args.encoder_dropout_out = args.get("encoder_dropout_out", 0)
    args.decoder_embed_dim = args.get("decoder_embed_dim", 1000)
    args.decoder_layers = args.get("decoder_layers", 4)
    args.decoder_out_embed_dim = args.get("decoder_out_embed_dim", 1000)
    args.decoder_dropout_out = args.get("decoder_dropout_out", 0)
    base_architecture(args)
